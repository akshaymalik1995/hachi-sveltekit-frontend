...
<div class="text-black dark:text-white max-w-4xl mx-auto">
  ...
  <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
    <div class="space-y-6">
      ...
      <div>
        <h3 class="text-xl font-semibold mb-3 text-gray-900 dark:text-gray-100">Camera Details</h3>
        <ul class="space-y-2 text-gray-600 dark:text-gray-400">
  ...
  {#if photoDetails.description}
    <div class="mt-6">
      <h3 class="text-xl font-semibold mb-3 text-gray-900 dark:text-gray-100">Description</h3>
      <p class="text-gray-600 dark:text-gray-400">{photoDetails.description}</p>
    </div>
  {/if}

  {#if photoDetails.tags}
    <div class="mt-6">
      <h3 class="text-xl font-semibold mb-3 text-gray-900 dark:text-gray-100">Tags</h3>
      <div class="flex flex-wrap gap-2">
        {#each photoDetails.tags.split(",") as tag}
          <span
            class="bg-blue-100 dark:bg-blue-900 text-blue-800 dark:text-blue-200 text-sm font-bold px-2.5 py-0.5 rounded"
            >{tag.trim()}</span
          >
        {/each}
      </div>
  ...
  <!-- {#if photoDetails.albums}
    <div class="mt-6">
      <h3 class="text-xl font-semibold mb-3 text-gray-900 dark:text-gray-100">Albums</h3>
